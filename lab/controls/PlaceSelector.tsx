...
export function PlaceSelector({ engine, places }: PlaceSelectorProps) {
  ...
  return (
    <div style={panelStyle}>
      <strong style={{ fontSize: 14 }}>Atlas Lab — Foundation 58</strong>
      <span style={{ fontSize: 12, color: "#555" }}>
        ...
        lines, polygons, and core circles follow geodesic-aware vertex placement with projection
        blend. Enable 3D Tiles for Re:Earth Buildings — async mesh-feature picks, structural
