...
export function PlaceSelector({ engine, places }: PlaceSelectorProps) {
  ...
  return (
    <div style={panelStyle}>
      <strong style={{ fontSize: 14 }}>Atlas Lab — Foundation 61</strong>
      <span style={{ fontSize: 12, color: "#555" }}>
        ...
        blend, Douglas–Peucker simplification, cached mercator/globe vertex lerp, and earcut-stable fill meshes with in-place position updates. Enable 3D Tiles for Re:Earth Buildings — async mesh-feature picks, structural
