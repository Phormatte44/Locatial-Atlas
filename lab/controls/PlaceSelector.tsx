...
export function PlaceSelector({ engine, places }: PlaceSelectorProps) {
  ...
  return (
    <div style={panelStyle}>
      <strong style={{ fontSize: 14 }}>Atlas Lab — Foundation 54</strong>
      <span style={{ fontSize: 12, color: "#555" }}>
        ...
        View-mode selector uses Atlas-owned `transitionViewMode()` for globe↔map blends; atmosphere
        and lighting interpolate with globeness during the transition. Enable 3D Tiles for Re:Earth
        Buildings — async mesh-feature picks, structural metadata on hover, click-to-frame single
        features, emissive highlight. Toggle POI layers for clustered landmarks — click a cluster
        to expand.
      </span>
